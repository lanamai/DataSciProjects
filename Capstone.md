...
sum(nchar(aso2$AnimalID) == 0)    # 0
sum(nchar(aso2$Named) == 0)       # 0
summary(aso2$Adopted)  
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.0000  0.0000  0.0000  0.4029  1.0000  1.0000 
sum(nchar(aso2$AnimalType) == 0)  # 0
sum(nchar(aso2$sex) == 0)         # 0
sum(nchar(aso2$Intact) == 0)      # 0
sum(nchar(aso2$PureBred) == 0)    # 0
...
# Animal LifeStage
barplot(table(aso2$LifeStage), main="Animal LifeStage")
